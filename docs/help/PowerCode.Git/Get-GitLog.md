...
HelpUri: https://github.com/powercode/PowerGit/blob/{{BranchName}}/docs/help/PowerCode.Git/Get-GitLog.md
Locale: en-US
...
One or more repository-relative file paths. Only commits that touched these files are returned.
